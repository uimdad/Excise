            ...
            <div class="modal fade" id="defaultModal" tabindex="-1" role="dialog">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
						...
						<div class="form-group">
                                        <div class="form-line">
                                            <input type="text" id="receivername" name="receivername" class="form-control" placeholder="Enter Reciver Name">
                                        </div>
                                    </div>
						</div>
						...
						<div class="form-group">
                                        <div class="form-line">
                                            <input type="text" id="receivercnic" name="receivercnic" class="form-control" placeholder="Enter Reciver Cnic">
                                        </div>
                                    </div>
						</div>
						...
						<div class="form-group">
                                        <div class="form-line">
                                            <input type="text" id="receivermobileno" name="receivermobileno" class="form-control" placeholder="Enter Receiver Mobile number">
                                        </div>
                                    </div>
						</div>
                                 ...
                                 <td><div class="btn-group" role="group">
                                    ...
                                    <div class="btn-group" role="group">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li><a href="javascript:void(0);" class=" waves-effect waves-block" data-toggle="modal" data-target="#defaultModal" class=" waves-effect waves-block" custom="<?php echo $data->vechileid; ?>" id="mra" onclick="clicked(this);">Release</a></li>
                                        </ul>
                                    </div>
                                </div></td>
                                        <td></td>
