                ...
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" id="largeModalLabel">Send To ETO</h4>
                        </div>
							<form  action="#" id="sendtoeto" enctype="multipart/form-data">
 ...
 <div class="card">
                        ...
                        <div class="body table-responsive">
                          <table id="warehouse_received" class="display" style="width:100%">
        <thead>
            <tr>
                <th>Seized By</th>
                <th>Seized Date</th>
